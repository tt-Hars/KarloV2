...
export const MODULES_SHARED_STORE_SRC_STORE_FEATURE_KEY = 'store';
...
export const storeSlice = createSlice({
  name: MODULES_SHARED_STORE_SRC_STORE_FEATURE_KEY,
...
export const getStoreState = (rootState: {
  [MODULES_SHARED_STORE_SRC_STORE_FEATURE_KEY]: StoreState;
}): StoreState => rootState[MODULES_SHARED_STORE_SRC_STORE_FEATURE_KEY];
